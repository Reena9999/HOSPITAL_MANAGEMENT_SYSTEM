...
public class DatabaseCreation {
    public static void main(String[] args) throws Exception {
        try{
            ...
            statement.executeUpdate("create table tblDoctor(DOCID int(10) AUTO_INCREMENT,FirstName varchar (50),LastName varchar(50),Specialization int(10),PhNumber varchar(10),Email varchar(10), location varchar(50),password varchar(50),PRIMARY KEY(DOCID))");
